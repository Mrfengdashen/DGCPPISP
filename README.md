...
## Datasets
  ...
  The protein pre-trained language model ESM-2 is obtained from [ESM-2](https://github.com/facebookresearch/esm). The version used in this article can be downloaded from [here](https://pan.baidu.com/s/17hyyi2mQQaf5jljmcgLbjQ?pwd=esm2).
## Using DGCPPISP
